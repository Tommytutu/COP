...
* *CI_bar*: the predetermined consistency index threshold for the Geometric Consistency Index (GCI), $\overline{\text{GCI}}=0.31$ when $n=3$; $\overline{\text{GCI}}=0.35$ when $n=4$ and $\overline{\text{GCI}}=0.37$ when $n>4$.
